...
//Klassen uthyrning representerar informationen om varje uthyrning och bygger en model för regler i databas.
...
namespace BusinessEntities_FrameWork.Models
{
    ...
    public class Uthyrning : IUthyrning
    {
        ...
        public Uthyrning()
        {
            UtrustningsTillUthyrning = new HashSet<Utrustning>(); 
        }
